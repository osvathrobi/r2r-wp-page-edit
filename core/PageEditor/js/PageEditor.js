var PageEditor = {
    ...
    init : function() {
        ...
        PageEditor.addNewModule('zone1', v1, 'tmpl_module_text');
        ...
        // PageEditor.addNewModule('zone3', v3, 'tmpl_module_text');
        PageEditor.addNewModule('zone2', v3, 'tmpl_module_heading');
        PageEditor.addNewModule('zone2', v3, 'tmpl_module_text');
        PageEditor.addNewModule('zone2', v3, 'tmpl_module_text');
