...
case 'textarea':
	...
	<tr>
		...
		<td width="80%"><textarea name="<?php echo $value['id']; ?>"
			...
			type="<?php echo $value['type']; ?>" cols="" rows=""><?php if ( get_settings( $value['id'] ) != "") { echo get_settings( $value['id'] ); } else { echo $value['std']; } ?></textarea></td>
...
case 'select':
	...
	<tr>
		...
		<td width="80%"><select style="width: 240px;"
			...
			<option
			<?php if ( get_settings( $value['id'] ) == $option) { echo ' selected="selected"'; } elseif ($option == $value['std']) { echo ' selected="selected"'; } ?>><?php echo $option; ?></option>
			<?php } ?>
		</select></td>
	</tr>
